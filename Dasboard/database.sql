...
CREATE TABLE IF NOT EXISTS projects (
    ...
    date_debut DATE,
    date_fin DATE,
    statut ENUM('en_cours', 'termine', 'en_pause', 'annule') NOT NULL DEFAULT 'en_cours',
...
INSERT INTO users (nom, prenom, email, password, telephone, poste, date_creation)
...
INSERT INTO projects (nom, description, date_debut, date_fin, statut, priorite, user_id, date_creation)
VALUES 
('Refonte site web', 'Refonte complète du site web de l\'entreprise', '2025-01-01', '2025-06-30', 'en_cours', 'haute', 1, NOW()),
('Application mobile', 'Développement d\'une application mobile pour les clients', '2025-02-15', '2025-08-15', 'en_cours', 'moyenne', 1, NOW()),
('Base de données', 'Migration de la base de données vers une nouvelle architecture', '2025-03-01', '2025-04-30', 'en_cours', 'haute', 1, NOW());
...
('Tester l\'application', 'Tests fonctionnels de l\'application mobile', 2, 1, 'pending', 'haute', '2025-04-01', '2025-04-15', NOW()),
